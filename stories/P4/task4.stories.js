	...
	useEffect(() => {
		...
		*/
		...
		cylinders.forEach(cylinder => {
			let emphasis = new autr.Emphasis(
				"Cylinders", 
				cylinder, 
				"any", // just from a code readability standpoint -- what is this 'any'? I don't know.
				{ "regression": { "stroke": colorScale(cylinder) } }
			)
			.include({ name: ["regression"] })
			.getAugs();
			draft.augment(emphasis);
		})
