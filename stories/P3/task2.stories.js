...
import { Emphasis, Draft } from "auteur";
...
export const Task2 = () => {
	...
	useEffect(() => {
		...
		*/
		...
		const countryEmphasis = new Emphasis("Country", ["Hong Kong, China", "Afghanistan", "Sweden", "Greece"])
		countryEmphasis.include({ name: ["stroke", "opacity", "label" ]})
		const regionEmphasis = new Emphasis("Region", "Sub-Saharan Africa")
		regionEmphasis.include({ name: ["stroke", "opacity" ]})
		
		const unionizedEmphasis = countryEmphasis.union(regionEmphasis)
