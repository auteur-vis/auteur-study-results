...
export const Task7 = () => {
	...
	useEffect(() => {
		...
		ADD AUTEUR CODE HERE
		*/
		const xThreshold = new Threshold("NewYork", "mean", "geq");
		xThreshold.selection(svgElement.selectAll(".temperatureSeattle,.temperatureCharlotte"));
		...
		draft.layer(ref.current)
		  .x("Month", xScale)
		  .y("NewYork", yScale)
		  .exclude({"name":["regression", "label", "fill"]})
